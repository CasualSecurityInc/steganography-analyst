...
source skills/steganography-analyst/scripts/env.sh   # add tools to PATH
```

Then point your agent at the skill that matches the task:
- `skills/steganalysis/SKILL.md` — "Is there hidden data here?"
- `skills/steganography-analyst/SKILL.md` — "How do I extract it?"
...
Both skills live under `skills/` per the Agent Skills specification.
